...
import {
  applyRoadmapForUser,
  getRoadmapByUserId,
} from "@/app/apiClient/learning/roadmap/roadmap";
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center border-2 border-dashed rounded-2xl p-10">
            <p className="text-gray-500 mb-4">
              {t("learning.roadmap.noRoadmaps")}
            </p>
            <Button onClick={() => setOpenModal(true)}>
              <PlusCircle className="mr-2 h-4 w-4" />{" "}
              {t("learning.roadmap.createNewRoadmap")}
            </Button>
          </div>
        ) : (
          <>
            ...
            <div className="grid grid-cols-1 gap-4">
              {paths.map((path, index) => (
                ...
                >
                  ...
                  {(path?.isCompleted ||
                    path?.currentweek >= path?.totalweeks) && (
                    <div
                      ...
                      style={{
                        ...
                        boxShadow:
                          "0 0 4px rgba(22,163,74,0.7), inset 0 0 8px rgba(22,163,74,0.4)",

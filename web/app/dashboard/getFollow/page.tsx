...
//       <h2 className="text-2xl font-bold mb-6 text-center">👥 Gợi ý bạn bè</h2>

//       <ul className="space-y-4">
//         {friends.length === 0 && (
//           <p className="text-gray-500 text-center">Không có gợi ý nào.</p>
//         )}
//         {friends.map((f) => (
//           <li
//             key={f.id}
